        ...
        <div className="container clearfix">
          ...
          <div className="float-right external-btns">
            <a
              ...
              <i className="fa fa-github mr-1" /> View Source
            </a>
            {!isRunningExtension && (
              <a
                ...
                <i className="fa fa-chrome mr-1" /> Use Extension
              </a>
            )}
            {isRunningExtension && (
              <a
                ...
                rel="noopener noreferrer"
                className="btn btn-danger d-none d-sm-none d-md-inline-block d-xl-inline-block d-lg-inline-block">
                <i className="fa fa-comment mr-1" /> Give Feedback
              </a>
            )}
            <a
              ...
              <i className="fa fa-twitter mr-1" /> Tweet
            </a>
            <div className="btn btn-dark btn-dark-toggle" />
          </div>
        </div>
      </div>
    );
